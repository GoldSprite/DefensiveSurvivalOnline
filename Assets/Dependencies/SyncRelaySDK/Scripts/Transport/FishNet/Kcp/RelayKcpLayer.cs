...
namespace Unity.Sync.Relay.Transport.FishNet
{
    ...
    { 
        ...
        public Action<RelayEvent, Channel> OnDispatchEvent = (e, channel) => Debug.LogWarning("OnDispatchEvent called with no handler");
        ...
        public void Connect(string ip, ushort port)
        {
            ...
            client = new KcpClient(
                ...
                (message) =>
                {
                    ...
                    {
                        OnDispatchEvent?.Invoke(e, Channel.Reliable);
                    }
                },
                () =>
                {
        ...
        public void Send(byte[] data, Channel channel)
        {
